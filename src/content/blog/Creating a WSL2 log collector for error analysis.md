...
This is an active work in progress and considered incomplete. This has not even been modularized by wrapping it into a function or even multiple smaller functions. 

I also feel it needs more assertions.

### collect_wsl_logs.ps1
```powershell
