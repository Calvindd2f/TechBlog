...
pubDate: Sept 6 2024
heroImage: /public/img/refactoring.png
...
if (! ($IsAdmin))
{
    ...
    $newProcess.Verb = "runas";
    [System.Diagnostics.Process]::Start($newProcess);
    [environment]::FastFail('This is an unpriviledged shell, please relaunch and attempt to use module as an administrator')
}
```
