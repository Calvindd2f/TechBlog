...
Once you make clear to client that if ISP requests to reset the router by using a pin to reset it (_this is their default move. Because if their is an issue, the actual underlying IT issue needs to be fixxed first, then you start back at square one_)
